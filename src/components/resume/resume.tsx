  ...
  return(
      <div>
        <div className="resume-container">
            ...
            <p><span>Programming Languages: </span>JavaScript, TypeScript, Golang, Rust, Java</p>
            <p><span>Notable Language Frameworks: </span> React, Node, Express, Actix</p>
            <p><span>Softer Skills: </span> Git, Github, Linux environments, CockroachDB, RESTful API's</p>
            <h1>
                Work Experience
            </h1>
            <div className="line"></div>
